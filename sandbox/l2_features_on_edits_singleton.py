...
statebuilder.make_neuron_neuroglancer_link(client, root_id)
...
y_pred = model.predict(joined_features[model.feature_names_in_])
posteriors = model.predict_proba(joined_features[model.feature_names_in_])
