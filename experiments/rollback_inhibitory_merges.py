...
def collate_edit_info(networkdeltas_by_operation, networkdeltas_by_metaoperation):
    ...
    edit_stats["centroid_distance_to_nuc"] = np.sqrt(
...
edit_stats, modified_level2_nodes = collate_edit_info(
    networkdeltas_by_operation, networkdeltas_by_metaoperation
)
